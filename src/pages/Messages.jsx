...
export default function Messages() {
  ...
  return <div className="pp-page min-h-screen px-6 pt-28 pb-16"><div className="mx-auto max-w-7xl">
    <header className="mb-6 rounded-[2rem] bg-[#12372a] p-7 text-white shadow-xl"><p className="text-xs font-black uppercase tracking-[.22em] text-[#c6ff4a]">Personalized requests</p><div className="mt-2 flex flex-col justify-between gap-4 md:flex-row md:items-end"><div><h1 className="text-3xl font-black text-white md:text-4xl">Coach conversations & quotes</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-white/80">Combine services, discuss the details, and approve or decline the coach’s final quote before making a payment.</p></div><div className="flex gap-3"><Metric label="Open conversations" value={openCount} /><Metric label="Quotes to review" value={sentQuotes} /></div></div></header>
