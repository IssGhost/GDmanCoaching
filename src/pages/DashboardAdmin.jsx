...
export default function DashboardAdmin() {
  return <div className="pp-page min-h-screen px-6 pt-28 pb-16"><div className="mx-auto max-w-7xl">
    <header className="overflow-hidden rounded-[2rem] bg-[#12372a] p-8 text-white shadow-xl"><div className="grid gap-6 lg:grid-cols-[1fr_.55fr] lg:items-end"><div><p className="text-xs font-black uppercase tracking-[.22em] text-[#c6ff4a]">Admin command center</p><h1 className="mt-2 text-4xl font-black text-white">GOOD Coaching operations</h1><p className="mt-3 max-w-2xl leading-7 text-white/75">Run coach approvals, customer support, payments, users, and platform records from one secure workspace.</p></div><div className="rounded-2xl bg-white/10 p-5"><FaShieldAlt className="text-2xl text-[#c6ff4a]"/><div className="mt-3 font-black text-white">Daily operating flow</div><div className="mt-2 space-y-2 text-sm text-white/75"><div>1. Approve complete coach profiles</div><div>2. Resolve support and access issues</div><div>3. Reconcile orders and payouts</div></div></div></div></header>
