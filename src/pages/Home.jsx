    ...
    <div className="pp-page">
          ...
          <div className="pp-card rounded-[2rem] p-5">
            <div className="pp-court-card relative overflow-hidden rounded-[1.5rem] p-5 text-white shadow-2xl">
              ...
              <div className="relative grid aspect-video place-items-center rounded-2xl border border-white/30 bg-white/15 backdrop-blur">
                <div className="grid h-20 w-20 place-items-center rounded-full bg-white/25 text-3xl shadow-xl">
                  <FaPlay />
                </div>

                <div className="absolute bottom-4 left-4 rounded-full bg-white/90 px-3 py-1 text-xs font-black text-[#12372a]">
                  Coach notes ready
                </div>
              </div>
          ...
          {[
            {
              ...
              text: "Profiles support photos, bios, DUPR details, specializations, and social links.",
            },
            {
              icon: FaCloudUploadAlt,
              title: "Video submission",
              text: "Upload up to 15 minutes of gameplay for your coach to review.",
            },
            {
              icon: FaUserTie,
              title: "Coach dashboard",
              text: "Coaches manage online options, assigned videos, profile details, and completed reviews.",
            },
          ].map((card) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          <Link to="/coaches" className="pp-btn-secondary px-5 py-3">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 pb-20">
        <div className="rounded-[2rem] border border-[#12372a]/10 bg-gradient-to-br from-[#fffef8] via-[#d9f7fb] to-[#fff1c7] p-8 shadow-2xl shadow-[#12372a]/10 md:p-10">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              <div className="flex text-[#ff7b54]">
                <FaStar />
                <FaStar />
                <FaStar />
                <FaStar />
